...
test("brand eye uses the approved animated asset, stays header-only, and keeps mobile sizes", async () => {
  ...
  assert.match(topbar, /src="\/brand-eye\.gif"/);
  ...
  assert.doesNotMatch(views, /brand-eye-poster|brand-eye-loop|brand-eye\.gif|sigilArtwork|sigilScan/);
